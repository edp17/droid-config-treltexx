# DisplayName: Jolla treltexx/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: treltexx
# DeviceVariant: treltexx
# Brand: Jolla
...
repo --name=adaptation-common-treltexx-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-treltexx-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-treltexx
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/treltexx
