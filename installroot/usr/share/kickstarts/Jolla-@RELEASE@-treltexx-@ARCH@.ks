...
repo --name=adaptation-community-common-treltexx-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
repo --name=mousetracker-@RELEASE@ --baseurl=http://repo.merproject.org/obs/home:/elros34:/sailfishapps/sailfishos_@RELEASE@/

%packages
@Jolla Configuration treltexx
%end
